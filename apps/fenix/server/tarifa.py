...
- **$10** — la lámina suelta. Una infografía de un tema ("la cultura postpunk a
  ...
  imprime y ya.
- **$43** — la regularización completa, y es el **TOPE**. Nada en esta papelería
  cuesta más de $43, aunque el trabajo haya sido enorme. Un techo que la mamá
  conoce de antemano vende más que un precio que hay que preguntar.

EL TECHO LO PUSO LA DUEÑA, no el costo. Arrancó en $25 y Lidia lo corrigió el
...
precio del mercado; su dato gana. Se le propuso la escalera 43–50 y cerró en
**"Perfecto 43"**: ése es el número, no el rango. Sigue siendo 3× más barato que
una hora de maestro particular ($100-300).
...
# exactamente el techo: la regularización completa vale $43 y ni un peso más.
...
VALE_EJEMPLOS = 8  # ejemplos resueltos paso a paso, lo del pizarrón
VALE_EJERCICIOS = 12  # ejercicios para que los haga solo
VALE_RESPUESTAS = 7  # la hoja que se separa para quien revisa
VALE_INVESTIGACION = 6  # fuentes verificadas, no inventadas
