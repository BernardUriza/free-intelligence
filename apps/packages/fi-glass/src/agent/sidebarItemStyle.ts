...
/* Los literales de esta hoja ya no se escriben a mano: se interpolan desde el
   contrato de tokens (glass-tokens.generated), la misma fuente que alimenta el
   Theme nativo de og118-ios — que transcribía ESTOS valores a ojo. */
const CSS = `
