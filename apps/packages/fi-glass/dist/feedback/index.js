...
// src/feedback/feedbackStyle.ts
var FI_CALLOUT_CLASS = "fi-callout";
var FI_CALLOUT_TITLE_CLASS = "fi-callout-title";
var FI_CALLOUT_BODY_CLASS = "fi-callout-body";
var FI_CALLOUT_LIST_CLASS = "fi-callout-list";
var FEEDBACK_STYLE_ID = "fi-feedback-style";
var CSS = `
.${FI_CALLOUT_CLASS} {
...
function Callout({ children, tone = "neutral", title, live, className }) {
  useFeedbackStyle();
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      role: anuncia ? "alert" : void 0,
      children: [
        title ? /* @__PURE__ */ jsx("strong", { className: FI_CALLOUT_TITLE_CLASS, children: title }) : null,
        /* @__PURE__ */ jsx("div", { className: FI_CALLOUT_BODY_CLASS, children })
      ]
    }
  );
}
function CalloutList({ items, tone, title, live, className }) {
  if (!items.length) return null;
  return /* @__PURE__ */ jsx(Callout, { tone, title, live, className, children: /* @__PURE__ */ jsx("ul", { className: FI_CALLOUT_LIST_CLASS, children: items.map((item, i) => /* @__PURE__ */ jsx("li", { children: item }, i)) }) });
}
export {
  Callout,
  CalloutList,
