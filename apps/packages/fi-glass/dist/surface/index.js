...
function Panel({ children, title, className }) {
  useSurfaceStyle();
  return /* @__PURE__ */ jsxs("section", { className: join(FI_PANEL_CLASS, className), children: [
    title ? /* @__PURE__ */ jsx("h2", { className: FI_PANEL_TITLE_CLASS, children: title }) : null,
    children
  ] });
}
...
function DataTable({ head, rows, rowHeader = false, className }) {
  ...
  return /* @__PURE__ */ jsxs("table", { className: join(FI_DATA_TABLE_CLASS, className), children: [
    head ? /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: head.map((celda, i) => /* @__PURE__ */ jsx("th", { children: celda }, i)) }) }) : null,
    /* @__PURE__ */ jsx("tbody", { children: rows.map((fila) => /* @__PURE__ */ jsx("tr", { children: fila.cells.map(
      (celda, i) => rowHeader && i === 0 ? /* @__PURE__ */ jsx("th", { scope: "row", children: celda }, i) : /* @__PURE__ */ jsx("td", { children: celda }, i)
    ) }, fila.key)) })
  ] });
}
export {
