...
function ChatWidgetContainer(props) {
  ...
  if (effectiveMode === "minimized") {
    return /* @__PURE__ */ jsxs4("div", { className: "chat-container-minimized", onClick: () => onModeChange("normal"), children: [
      /* @__PURE__ */ jsx5(MessageCircle2, { className: "chat-container-minimized-icon" }),
      /* @__PURE__ */ jsx5("span", { className: "chat-container-minimized-title", children: title }),
      /* @__PURE__ */ jsx5(
        "button",
        {
          onClick: (e) => {
          ...
          children: /* @__PURE__ */ jsx5("div", { className: "chat-container-minimized-pulse" })
        }
      )
    ] });
  }
  if (effectiveMode === "expanded" && isTablet) {
    return /* @__PURE__ */ jsxs4(Fragment, { children: [
      /* @__PURE__ */ jsx5("div", { className: "chat-backdrop", onClick: () => onModeChange("normal") }),
      /* @__PURE__ */ jsx5(
        "div",
        {
  ...
  if (embedded && (effectiveMode === "fullscreen" || effectiveMode === "dense")) {
    return /* @__PURE__ */ jsx5("div", { className: "chat-container-embedded", children });
  }
  if (effectiveMode === "dense") {
    return /* @__PURE__ */ jsx5("div", { className: "chat-container-dense", children });
  }
  if (effectiveMode === "fullscreen") {
    return /* @__PURE__ */ jsx5("div", { className: "chat-container-fullscreen", children });
  }
  return /* @__PURE__ */ jsx5("div", { className: "chat-container-normal", children });
}
...
function ChatWidgetHeader({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: `${backgroundClass} chat-header`, children: [
    /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-3 min-w-0", children: [
      /* @__PURE__ */ jsx6(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsx6(MessageCircle3, { className: "h-5 w-5 text-white" })
        }
      ),
      /* @__PURE__ */ jsxs5("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsx6("h3", { className: "chat-header-title", children: title }),
        subtitle && /* @__PURE__ */ jsx6("p", { className: "chat-header-subtitle", children: subtitle })
      ] })
    ] }),
    /* @__PURE__ */ jsx6("div", { className: "chat-header-controls", children: showControls && /* @__PURE__ */ jsxs5(Fragment2, { children: [
      showHistorySearch && onHistorySearch && mode !== "minimized" && /* @__PURE__ */ jsx6("button", { onClick: onHistorySearch, className: HEADER_BTN_CLASS, "aria-label": "Search history", title: "Buscar en historial", type: "button", children: /* @__PURE__ */ jsx6(Search, { className: "h-4 w-4" }) }),
      mode === "fullscreen" && onToggleDenseMode && /* @__PURE__ */ jsx6("button", { onClick: onToggleDenseMode, className: HEADER_BTN_CLASS, "aria-label": "Cambiar a modo denso", title: "Modo denso (sin controles)", type: "button", children: /* @__PURE__ */ jsxs5("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", viewBox: "0 0 16 16", children: [
        /* @__PURE__ */ jsx6("path", { d: "M0 3.5A1.5 1.5 0 0 1 1.5 2h13A1.5 1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5v-9zM1.5 3a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-13z" }),
        /* @__PURE__ */ jsx6("path", { d: "M3 4.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5z" })
      ] }) }),
      mode === "dense" && onToggleDenseMode && /* @__PURE__ */ jsx6("button", { onClick: onToggleDenseMode, className: HEADER_BTN_CLASS, "aria-label": "Cambiar a modo expandido", title: "Modo expandido (con controles)", type: "button", children: /* @__PURE__ */ jsxs5("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", viewBox: "0 0 16 16", children: [
        /* @__PURE__ */ jsx6("path", { d: "M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" }),
        /* @__PURE__ */ jsx6("path", { d: "M6.5 4.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1 0-1h2V5a.5.5 0 0 1 .5-.5zM8 8.5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1 0-1h2v-2a.5.5 0 0 1 .5-.5zm3-4a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1 0-1h2V5a.5.5 0 0 1 .5-.5zm0 6a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1 0-1h2v-2a.5.5 0 0 1 .5-.5z" })
      ] }) }),
      mode === "expanded" && /* @__PURE__ */ jsx6("button", { onClick: onMinimize, className: HEADER_BTN_CLASS, "aria-label": "Restaurar tama\xF1o", title: "Restaurar a tama\xF1o normal", type: "button", children: /* @__PURE__ */ jsx6(Minimize2, { className: "h-4 w-4" }) }),
      mode === "normal" && /* @__PURE__ */ jsx6("button", { onClick: onMaximize, className: HEADER_BTN_CLASS, "aria-label": "Expandir", title: "Expandir (60% m\xE1s grande)", type: "button", children: /* @__PURE__ */ jsx6(Maximize2, { className: "h-4 w-4" }) }),
      /* @__PURE__ */ jsx6("button", { onClick: onClose, className: HEADER_BTN_CLASS, "aria-label": "Close", title: "Cerrar", type: "button", children: /* @__PURE__ */ jsx6(X, { className: "h-5 w-5" }) })
    ] }) })
  ] });
}

// src/shell/ChatToolbar.tsx
import { useState as useState13, useRef as useRef8, useEffect as useEffect13 } from "react";
...
function ConcentricRings({ color = "yellow-500" }) {
  ...
  return /* @__PURE__ */ jsx8(Fragment3, { children: rings.map((ring, i) => /* @__PURE__ */ jsx8(
    motion.div,
    {
...
import { useEffect as useEffect4, useMemo, useRef as useRef2, useSyncExternalStore as useSyncExternalStore2 } from "react";
...
import { useState as useState5, useRef as useRef5, useEffect as useEffect7 } from "react";
...
import { useState as useState7, useRef as useRef6, useCallback as useCallback5, useEffect as useEffect8 } from "react";

// src/voice/useAudioQueue.ts
import { useState as useState8, useEffect as useEffect9, useCallback as useCallback6 } from "react";
...
import { useCallback as useCallback8, useEffect as useEffect12, useMemo as useMemo3, useRef as useRef7, useState as useState12 } from "react";
...
function ChatToolbar({
  ...
  return /* @__PURE__ */ jsxs15("div", { className: "chat-toolbar", children: [
    /* @__PURE__ */ jsxs15("div", { className: "fi-flex-gap-sm", children: [
      showPersonaSelector && personaSelector,
      (showAttach || showLanguage || showFormatting) && /* @__PURE__ */ jsxs15("div", { className: "relative", children: [
        /* @__PURE__ */ jsx20(
          "button",
          {
            ...
            /* @__PURE__ */ jsxs15(
              "div",
              {
                ...
                children: [
                  ...
                  showFormatting && /* @__PURE__ */ jsxs15(
                    "button",
                    {
                      onClick: () => {
                        onFormatting?.();
                  ...
                  showCopyCurl && /* @__PURE__ */ jsxs15(Fragment4, { children: [
                  ...
                  showThinkingToggle && /* @__PURE__ */ jsxs15("div", { className: "@md:hidden", children: [
                    /* @__PURE__ */ jsx20("div", { className: "chat-dropdown-divider" }),
                    /* @__PURE__ */ jsxs15(
                      "button",
                      {
                  ...
                  showClear && /* @__PURE__ */ jsxs15("div", { className: "@md:hidden", children: [
                    /* @__PURE__ */ jsx20("div", { className: "chat-dropdown-divider" }),
                    /* @__PURE__ */ jsxs15(
                      "button",
                      {
    ...
    /* @__PURE__ */ jsxs15("div", { className: "fi-flex-gap-sm", children: [
      ...
      /* @__PURE__ */ jsx20(
        "button",
        {
          ...
          children: sendLoading ? /* @__PURE__ */ jsx20(Loader211, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx20(Send, { className: "h-4 w-4" })
        }
      )
    ] })
  ] });
...
function ChatFilePreview({
  ...
  return /* @__PURE__ */ jsxs16("div", { className: `
    ...
    /* @__PURE__ */ jsx21("div", { className: `
      ...
      `, children: isProcessing ? /* @__PURE__ */ jsx21(Loader212, { className: "w-5 h-5 fi-text-primary animate-spin" }) : isCompleted ? /* @__PURE__ */ jsx21(CheckCircle, { className: "w-5 h-5 fi-text-success" }) : isError ? /* @__PURE__ */ jsx21(AlertCircle4, { className: "w-5 h-5 fi-text-error" }) : /* @__PURE__ */ jsx21(FileIcon, { className: "w-5 h-5 fi-text" }) }),
    /* @__PURE__ */ jsxs16("div", { className: "flex-1 min-w-0", children: [
      ...
      /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2 fi-text-xs", children: [
        /* @__PURE__ */ jsx21("span", { children: formatFileSize(file.size) }),
        isUploading && /* @__PURE__ */ jsxs16(Fragment5, { children: [
        ...
        isProcessing && /* @__PURE__ */ jsxs16(Fragment5, { children: [
          /* @__PURE__ */ jsx21("span", { children: "-" }),
          /* @__PURE__ */ jsx21("span", { className: "fi-text-primary", children: "Procesando..." })
        ] }),
        isCompleted && /* @__PURE__ */ jsxs16(Fragment5, { children: [
          /* @__PURE__ */ jsx21("span", { children: "-" }),
          /* @__PURE__ */ jsx21("span", { className: "chat-file-status-indexed", children: "Indexado" })
        ] }),
        isError && error && /* @__PURE__ */ jsxs16(Fragment5, { children: [
          /* @__PURE__ */ jsx21("span", { children: "-" }),
...
function ChatStartScreen({
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsx22("div", { className: "chat-start-screen", children: /* @__PURE__ */ jsxs17("div", { className: "chat-start-container", children: [
      ...
      /* @__PURE__ */ jsxs17("div", { className: "fi-stack-sm", children: [
  ...
  return /* @__PURE__ */ jsx22("div", { className: "chat-start-screen", children: /* @__PURE__ */ jsxs17("div", { className: "chat-start-container", children: [
    ...
    /* @__PURE__ */ jsxs17("div", { className: "fi-stack-sm", children: [
      /* @__PURE__ */ jsxs17("h3", { className: "chat-start-title-large", children: [
        "Hola, ",
    ...
    /* @__PURE__ */ jsxs17("div", { className: "chat-start-features", children: [
      /* @__PURE__ */ jsxs17("div", { className: "chat-start-feature", children: [
    ...
    /* @__PURE__ */ jsx22("button", { onClick: onStart, disabled: isLoading, className: "chat-start-btn-begin", children: isLoading ? /* @__PURE__ */ jsxs17(Fragment6, { children: [
...
function ChatContent({
  ...
  return /* @__PURE__ */ jsxs18("div", { className: "relative flex h-full flex-1 flex-col overflow-hidden", children: [
    !isHistoryOpen && /* @__PURE__ */ jsxs18(
      ChatWidgetContainer,
      {
        mode: viewMode,
        title: config.title,
        ...
        children: [
          ...
          messageCount === 0 && loadingInitial ? /* @__PURE__ */ jsx23("div", { className: "flex h-full items-center justify-center", children: /* @__PURE__ */ jsx23(Loader213, { className: "h-8 w-8 animate-spin text-slate-400" }) }) : messageCount === 0 && !isTyping && customEmptyState ? customEmptyState : messageCount === 0 && !isTyping ? /* @__PURE__ */ jsx23(
            ChatStartScreen,
            {
              isAuthenticated,
              userName,
          ...
          customQuickReplies,
          viewMode !== "dense" && /* @__PURE__ */ jsx23("div", { className: "chat-input-wrapper", children: /* @__PURE__ */ jsxs18("div", { className: "chat-input-floating-box", children: [
