...
// Note: We have a local ChatHistorySearchResponse which differs from
// the HistorySearchResponse exported by assistant.ts
...
/** @deprecated Use ChatHistorySearchResponse instead */
export type HistorySearchResult = ChatHistorySearchResponse;
