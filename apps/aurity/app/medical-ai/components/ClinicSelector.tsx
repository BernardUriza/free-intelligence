 ...
 * ClinicSelector
 *
 * Dropdown to select a clinic when user is superadmin.
 * Allows switching between clinics to view different doctors' calendars.
 */
            ...
            {clinics.length === 0 ? (
              ...
              clinics.map((clinic) => {
                ...
                return (
                  ...
                  >
                    <div className={`ui-dropdown-avatar ${isSelected ? 'bg-cyan-500/30' : 'bg-slate-700'}`}>
                      <Building2 className="w-4 h-4 text-cyan-400" />
                    </div>
