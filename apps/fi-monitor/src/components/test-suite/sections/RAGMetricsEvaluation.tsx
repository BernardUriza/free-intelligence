    ...
    <div className="rag-metrics-evaluation space-y-4">
      ...
      {isRunning && (
        <div className="text-center py-8">
          ...
          <p className="mt-4 text-gray-600">Evaluating queries...</p>
        </div>
      )}
      ...
      {!isRunning && results.length > 0 && (
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-purple-50 rounded-lg">
            <div>
              <p className="text-xs text-gray-600 mb-1">Avg Recall</p>
              <ProgressBar
            ...
            <div>
              <p className="text-xs text-gray-600 mb-1">Avg Precision</p>
              <ProgressBar
            ...
            <div>
              <p className="text-xs text-gray-600 mb-1">Avg MRR</p>
              <ProgressBar
            ...
            <div>
              <p className="text-xs text-gray-600 mb-1">Avg NDCG</p>
              <ProgressBar
            ...
            {results.map((result, idx) => (
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-xs text-gray-600 mb-1">NDCG</p>
