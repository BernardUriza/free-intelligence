...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            fi_monitor::detection::check_fi_monitor_installed,
            fi_monitor::install::launch_fi_monitor,
            fi_monitor::download::download_fi_monitor,
            fi_monitor::install::install_fi_monitor_silent,
            fi_monitor::install::install_fi_monitor_full,
            // WSL integration (Windows backend)
            wsl::detection::check_wsl_status,
            wsl::install::install_wsl,
            wsl::install::enable_wsl_feature,
            wsl::backend::setup_wsl_backend,
            wsl::backend::start_wsl_backend,
            wsl::backend::stop_wsl_backend,
            wsl::backend::check_wsl_backend_health,
            wsl::backend::get_wsl_backend_logs,
            // Auth0 OAuth commands
            auth::flow::configure_auth0,
            auth::flow::start_auth_flow,
            auth::flow::handle_auth_callback,
            auth::keychain::get_stored_tokens,
            auth::tokens::refresh_tokens,
            auth::keychain::clear_tokens,
            auth::tokens::is_token_expired,
            auth::tokens::get_token_expiry,
            // License commands
