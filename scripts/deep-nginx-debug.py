...
client.connect('104.131.175.65', username='root', password='FreeIntel2024DO!', look_for_keys=False, timeout=30)
...
stdin, stdout, stderr = client.exec_command('killall nginx 2>/dev/null ; sleep 2 ; systemctl start nginx ; sleep 2')
