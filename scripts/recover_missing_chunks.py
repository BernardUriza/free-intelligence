...
with h5py.File(
    "/Users/bernardurizaorozco/Documents/free-intelligence/storage/diarization.h5", "r+"
) as f:
    ...
    for chunk_idx in missing_chunks:
        ...
        try:
            ...
            result = whisper_svc.transcribe(
                audio_path, segment_duration=chunk_size_sec, start_time=start_time, language="es"
            )
