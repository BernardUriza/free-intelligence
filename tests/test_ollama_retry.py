...
class TestCircuitBreaker:
    ...
    def test_circuit_closes_after_window(self) -> None:
    ...
    def test_circuit_tracks_failures_in_window(self) -> None:
    ...
    def test_circuit_breaker_with_successful_request(self) -> None:
