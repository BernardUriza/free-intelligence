...
class TestTimelineAPI(unittest.TestCase):
    ...
    def test_list_sessions_performance(self):
    ...
    def test_get_session_detail_performance(self):
    ...
    def test_list_events_with_session_filter(self):
    ...
    def test_list_events_with_who_filter(self):
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_format_size_human_tokens(self):
    ...
    def test_format_size_human_chars(self):
    ...
    def test_format_size_human_zero(self):
