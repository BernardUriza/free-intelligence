...
class TestCommitMessageValidator(unittest.TestCase):
    ...
    def test_valid_fix_without_scope(self) -> None:
    ...
    def test_invalid_no_space_after_colon(self) -> None:
        """Debe rechazar mensaje sin espacio después de colon."""
        message = "feat:add feature"
        is_valid, error = validate_commit_message(message)
        self.assertFalse(is_valid)

    def test_invalid_uppercase_message(self) -> None:
    ...
    def test_valid_uppercase_proper_noun(self) -> None:
    ...
    def test_scope_with_dash(self) -> None:
