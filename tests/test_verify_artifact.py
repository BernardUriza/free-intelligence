...
class TestVerifyArtifact:
    ...
    def test_verify_artifact_exists(self, tmp_path):
    ...
    def test_verify_artifact_large_md(self, tmp_path):
    ...
    def test_verify_artifact_small_md_allowed(self, tmp_path):
    ...
    def test_verify_artifact_valid_extensions(self, tmp_path):
    ...
    def test_verify_artifact_invalid_extension(self, tmp_path):
...
class TestVerifyAll:
    ...
    def test_verify_all_returns_results(self):
    ...
    def test_verify_all_with_custom_path(self, tmp_path):
...
class TestArtifactRegistry:
    ...
    def test_registry_has_required_cards(self):
    ...
    def test_registry_no_duplicate_paths(self):
...
class TestIntegration:
    ...
    def test_all_registered_artifacts_exist(self):
    ...
    def test_verify_artifact_script_executable(self):
