...
class TestAppendOnlyPolicy(unittest.TestCase):
    ...
    def test_append_interaction_allowed(self):
    ...
    def test_append_embedding_allowed(self):
    ...
    def test_direct_mutation_blocked(self):
    ...
    def test_validate_write_index_new(self):
    ...
    def test_validate_resize_increase(self):
    ...
    def test_validate_resize_decrease(self):
    ...
    def test_multiple_appends_allowed(self):
    ...
    def test_policy_exit_verification(self):
