...
class TestAssistantSchemas:
    ...
    def test_message_model(self):
        ...
        from backend.core.services.assistant.api.public.assistant_schemas import Message
    ...
    def test_chat_completion_request(self):
        ...
        from backend.core.services.assistant.api.public.assistant_schemas import (
