...
def test_memory_response_schema_structure() -> None:
    ...
    from backend.services.memory.api.public.longitudinal_memory import (
...
def test_memory_event_schema_structure() -> None:
    ...
    from backend.services.memory.api.public.longitudinal_memory import MemoryEvent
...
def test_memory_stats_response_schema_structure() -> None:
    ...
    from backend.services.memory.api.public.longitudinal_memory import MemoryStatsResponse
