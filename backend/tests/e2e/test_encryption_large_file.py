...
from backend.infrastructure.workers.tasks.encryption.constants import CHUNK_SIZE_BYTES
from backend.infrastructure.workers.tasks.encryption.worker import (
    chunk_large_data,
