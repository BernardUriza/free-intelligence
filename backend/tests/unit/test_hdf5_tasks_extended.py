...
class TestChunkOperations:
    ...
    def test_get_task_chunks_import(self) -> None:
        ...
        from backend.src.fi_storage.infrastructure.hdf5.tasks.chunks import get_task_chunks
...
class TestSoapOperations:
    ...
    def test_save_soap_data_path(
        ...
        from backend.src.fi_storage.infrastructure.hdf5.tasks.soap import save_soap_data
...
class TestModuleExports:
    ...
    def test_tasks_package_exports(self) -> None:
        ...
        from backend.src.fi_storage.infrastructure.hdf5 import tasks
    ...
    def test_h5_file_access_exports(self) -> None:
        ...
        from backend.src.fi_storage.infrastructure.hdf5.tasks import h5_file_access
    ...
    def test_lifecycle_exports(self) -> None:
        ...
        from backend.src.fi_storage.infrastructure.hdf5.tasks import lifecycle
    ...
    def test_soap_exports(self) -> None:
        ...
        from backend.src.fi_storage.infrastructure.hdf5.tasks import soap
