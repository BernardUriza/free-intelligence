"""Assistant Introduction API - Onboarding greeting.

Generates personalized introduction for new users.

Endpoints:
- POST /introduction - Get persona introduction

Migrated from: backend/api/routers/assistant/public/assistant/introduction.py
"""
...
from .schemas import IntroductionRequest, IntroductionResponse
