"""Assistant Streaming Chat API - SSE streaming responses.

Streaming endpoint that proxies to internal LLM streaming endpoint.

Endpoints:
- POST /chat/stream - Stream AI response via SSE

Migrated from: backend/api/routers/assistant/public/assistant/stream.py
"""
