...
Migrated from: backend/api/routers/assistant/public/assistant_schemas.py
"""
...
class ChatCompletionRequest(BaseModel):
    ...
    enable_thinking: bool = Field(
        default=True,
        description="Enable model reasoning/thinking (Qwen3). Set false to skip thinking phase.",
    )
...
class ChatCompletionResponse(BaseModel):
    ...
    thinking: str | None = Field(
        None,
        description="Model reasoning/thinking process (Qwen3 thinking mode).",
    )
...
class InteractionResult(BaseModel):
    ...
    model: str | None = None  # LLM model that generated response
