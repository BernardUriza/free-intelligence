"""Transcription Streaming API - Upload chunks, poll jobs, end sessions.

Audio transcription workflow with Strategy Pattern for medical/chat modes:
...
async def stream_chunk(
    ...
    Uses ChunkHandler abstraction for medical/chat workflows.
...
async def get_job_status(
    session_id: str,
    _service: TranscriptionService = Depends(get_transcription_service),  # kept for backward compat
    audit_service: DIAuditService = Depends(get_audit_service),
