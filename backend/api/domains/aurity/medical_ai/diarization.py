...
CRUD operations for diarization segments:
- Get diarization job status
- Get diarization segments for a session
- Update individual segment text
- Import external diarization (Cue, AssemblyAI, etc.)

Migrated from: backend/api/routers/session/public/sessions_pkg/diarization.py
"""
