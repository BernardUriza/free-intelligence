"""Transcription sources retrieval endpoint.

Returns all three transcription sources for a session:
- webspeech_final: Real-time Web Speech API results
- transcription_per_chunks: Server-side chunked transcription
- full_transcription: Combined full text

Migrated from: backend/api/routers/session/public/sessions_pkg/transcription_sources.py
"""
