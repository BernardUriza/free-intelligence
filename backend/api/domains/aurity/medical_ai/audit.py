"""Medical audit endpoints.

Doctor review and feedback for AI-generated medical notes:
- Get session audit data (SOAP note, diarization, flags)
- Submit doctor feedback with corrections

Migrated from: backend/api/routers/session/public/sessions_pkg/audit.py
"""
...
async def get_session_audit(
    ...
    try:
        ...
        soap_task_meta = task_repo.get_task_metadata(session_id, TaskType.SOAP_GENERATION)
        diarization_segments = task_repo.get_diarization_segments(session_id)
                ...
                for correction in feedback.corrections:
                    ...
                    if section in soap_data:
                        if isinstance(soap_data[section], str):
                            ...
                            soap_data[section]["corrections"].append(correction.model_dump())
                            corrections_applied += 1

                task_repo.save_soap_data(session_id, soap_data, TaskType.SOAP_GENERATION)
