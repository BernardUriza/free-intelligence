...
class Message(BaseModel):
    ...
    name: str | None = Field(None, description="Optional name for the author (for function calling)")
...
class ChatCompletionChoice(BaseModel):
    ...
    finish_reason: str = Field(..., description="Reason the generation finished", examples=["stop", "length", "function_call"])
...
class ChatCompletionResponse(BaseModel):
    ...
    # AURITY-specific extensions
    persona: str = Field(default="general_assistant", description="AURITY persona used for this response")
