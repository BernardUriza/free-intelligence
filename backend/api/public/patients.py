...
class PatientCreate(BaseModel):
    ...
    curp: Optional[str] = Field(None, min_length=18, max_length=18, description="CURP (18 chars)")
...
def list_patients(
    search: Optional[str] = Query(None, description="Search by nombre or apellido"),
