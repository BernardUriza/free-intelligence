...
from backend.src.fi_prescription.models.allergy import AllergyCheckResult
from backend.src.fi_prescription.models.interaction import InteractionCheckResult
...
from backend.src.fi_prescription.models.template import (
...
class TemplateEngine:
    ...
    def _parse_medications_from_text(
        ...
        if use_ai:
            try:
                from backend.src.fi_prescription.services.medication_extractor import (
