...
def init_keys(
    ...
    """
    from fi_license import generate_keypair
...
def info(
    ...
    """
    from fi_license import decode_license_key
...
def export_pubkey(
    ...
    """
    from fi_license import get_public_key_for_embedding
    from fi_license.generator import PUBLIC_KEY_PATH
