...
from backend.core.domain.prescription.data.interactions_catalog import DRUG_INTERACTIONS_CATALOG
from backend.core.domain.prescription.models.interaction import (
    DrugInteraction,
    InteractionAlert,
