...
from backend.core.infrastructure.events.application.replay import replay_aggregate
from backend.core.infrastructure.events.domain.events import EventType
from backend.core.infrastructure.events.infrastructure.consumer_offsets import get_offset_store
...
async def prometheus_metrics() -> StreamingResponse:
    ...
    """
    from backend.core.infrastructure.events.observability.metrics import get_metrics
...
async def tracing_stats() -> dict[str, Any]:
    ...
    Returns:
        Stats dict
    """
    from backend.core.infrastructure.events.observability.tracing import get_tracer
