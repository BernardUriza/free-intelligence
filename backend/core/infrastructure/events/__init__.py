...
Usage:
    from backend.core.infrastructure.events import EventBus, DomainEvent, EventType
...
# Replay
from backend.core.infrastructure.events.application.replay import (
    ReplayResult,
    replay_aggregate,
)

# Contracts
from backend.core.infrastructure.events.domain.contracts import (
    get_contract,
    list_contracts,
    validate_payload,
)
...
# Identity
from backend.core.infrastructure.events.domain.identity import (
    generate_dedupe_key,
    generate_event_id,
)

# Consumer offsets
from backend.core.infrastructure.events.infrastructure.consumer_offsets import (
    ConsumerLag,
    ConsumerPosition,
    get_offset_store,
)
...
# Snapshots
from backend.core.infrastructure.events.infrastructure.snapshots import (
    SnapshotStore,
    get_snapshot_store,
)

# Projections
from backend.core.infrastructure.events.projections import (
    get_registry,
