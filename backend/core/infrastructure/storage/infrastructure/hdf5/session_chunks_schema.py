...
Migration:
  OLD: from backend.core.infrastructure.storage.infrastructure.hdf5.session_chunks_schema import append_chunk_to_session
  NEW: from backend.utils.common.infrastructure.persistence.hdf5.task_repository import append_chunk_to_task, ensure_task_exists
...
from backend.utils.common.infrastructure.persistence.hdf5.task_repository import (
