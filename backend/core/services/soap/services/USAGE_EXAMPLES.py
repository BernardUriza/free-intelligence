...
def example_basic_usage() -> None:
    ...
    from backend.core.services.soap.services.llm_client import OllamaClient
...
def example_error_handling() -> None:
    ...
    from backend.core.services.soap.services.llm_client import OllamaClient
    from backend.core.services.soap.services.response_parser import OllamaExtractionError
...
def example_response_parser_direct() -> None:
    ...
    from backend.core.services.soap.services.response_parser import OllamaResponseParser
...
async def example_async_usage_future() -> None:
    ...
    """
    # from backend.core.services.soap.services.llm_client_async import (
    #     OllamaClientAsync,
    # )
    #
