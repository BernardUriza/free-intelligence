...
Note: This package also contains personas/, secrets.py, and other config files.
"""
from pathlib import Path
import os

# Project root (parent of backend/ directory)
# Note: __file__ is backend/config/__init__.py, so parent.parent.parent gets project root
...
# NOTE: NEW_API_STRUCTURE_ENABLED removed in Phase 5 (Hadopelágica)
# All routes now use domain-based structure at /api/aurity/*
# Legacy /api/workflows/aurity/* routes have been removed
