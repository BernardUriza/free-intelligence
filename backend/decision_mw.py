...
class DecisionMiddleware:
    ...
    def __init__(self, rules_path: str = "config/decision_rules.yaml"):
        ...
        self.logger.info("DECISION_MIDDLEWARE_INITIALIZED",
    ...
    def _load_rules(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info("RULES_LOADED_SUCCESSFULLY",
                           presets=list(rules.keys()),
    ...
    def apply_rules(
        ...
        self.logger.info("RULES_APPLICATION_STARTED",
                        preset_id=preset_id,
            ...
            if matches:
                ...
                for action in actions:
                    if action.get('type') == 'emit_event':
                        ...
                        self.logger.info("DECISION_EVENT_EMITTED",
                        ...
                        getattr(self.logger, log_level)("RULE_ACTION_LOG",
                                                        rule_name=rule_name,
                                                        message=message)
        ...
        self.logger.info("RULES_APPLICATION_COMPLETE",
                        preset_id=preset_id,
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Free Intelligence Decision Middleware CLI"
    )
    ...
    apply_parser.add_argument('--first-match', action='store_true',
                            help='Stop on first matching rule')
    ...
    if args.command == 'list':
        ...
        events = mw.apply_rules(
            args.preset_id,
            data,
            stop_on_first_match=args.first_match
        )
