...
def __getattr__(name: str):
    ...
    if name == "get_logger":
        ...
        from backend.common.fi_common.logging.logger import init_logger_from_config

        return init_logger_from_config
    elif name == "LLMCache":
        from backend.common.fi_common.cache.cache import LLMCache

        return LLMCache
    elif name == "MetricsCollector":
        from backend.common.fi_common.metrics.metrics import MetricsCollector
        ...
        from backend.common.fi_common.config.config_loader import load_config
