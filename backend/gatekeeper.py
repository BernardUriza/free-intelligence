...
class QualityScorer:
    ...
    QUALITY_KEYWORDS = [
        ...
        'patient', 'treatment', 'diagnosis', 'symptom', 'condition',
        'data', 'analysis', 'result', 'research', 'study'
    ]

    # Indicators of truncation or incompleteness
    TRUNCATION_INDICATORS = [
        '...', '[truncated]', '[continued]', 'to be continued',
        'part 1 of', 'see next', 'more details in'
    ]

    # Negative sentiment keywords (for health queries, should be neutral/positive)
    NEGATIVE_KEYWORDS = [
        'unfortunately', 'sadly', 'regrettably', 'cannot help',
        'unable to', 'sorry', "don't know", 'uncertain'
    ]
...
class Gatekeeper:
    ...
    def evaluate_response_quality(
        ...
        response: str,
        provider: str,
        should_fallback_on_low_score: bool = True
...
def main():
    ...
    if args.command == 'score':
        ...
        test_cases = [
            ...
            ("Who is Alice?", "Alice is the protagonist of Alice in Wonderland, written by Lewis Carroll. She is a curious young girl who falls down a rabbit hole into a fantastical world. Throughout her adventures, she meets various eccentric characters and experiences many bizarre situations.", "ollama"),
