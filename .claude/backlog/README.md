...
| [RESONANCE — modo llamada de voz sin pantalla](og118-resonance-voice-mode.md) | **Done** (verificado 2026-08-23) — máquina de llamada, barge-in, VAD y hangup por inactividad en fi-glass, consumidos por og118. **2026-09-09: se estudió el default-on y NO se hizo.** El fallo de voz era mudo en dos capas y ya se arregló (fi-glass gana `onError`; og118 lo pinta en el banner que ya existía). Falta UNA cosa para quitar el flag: medir costo/minuto de llamada y poner un tope — no hay ninguno | 2026-06-29 |
